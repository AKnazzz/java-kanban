...
public class HTTPTaskManager extends FileBackedTasksManager {
    ...
    public static HTTPTaskManager loadFromKVServer(String uriString) {
        ...
        if (jsonEpics != null) {
            epicList = gsonWithSubtaskAdapter.fromJson(jsonEpics, new TypeToken<ArrayList<Epic>>() {
            }.getType());
        }
        ...
        if (jsonSubtasks != null) {
            subtaskList = gsonWithEpicAdapter.fromJson(jsonSubtasks, new TypeToken<ArrayList<Subtask>>() {
            }.getType());
        }
        ...
        if (jsonHistory != null) {
            historyIdTasks = gson.fromJson(jsonHistory, new TypeToken<ArrayList<Integer>>() {
            }.getType());
        }
