...
public interface TaskManager {
    ...
    List<Task> getAllTasks();          // 1. метод для получения списка всех TASK
    ...
    int createNewTask(Task task);            //  4. метод для создания новой задачи типа (TASK)
    ...
    List<Epic> getAllEpics();          // 1. метод для получения списка всех сложных задач EPIC
    ...
    int createNewEpic(Epic epic);            // 4.метод для создания новой сложной задачи (EPIC)
    ...
    List<Subtask> getAllSubtasks();    // 1. метод для получения списка всех SUBTASK
    ...
    int createNewSubTask(Subtask subTask);     // 4. метод для создания подзадачи SUBTASK
